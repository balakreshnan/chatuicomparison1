...
def get_intent_to_process(response,firstllm, message):
    returntext = ""
    system_prompt = """You are given a question from customer. It is your job to identify
...
def default_message(message, history, firstllm, system_prompt, prompt_1):
    ...
    system_prompt = """You are given a question from customer. Please answer with your knowledge. \n\n
